               ...
               <div className="container-fluid">
                    ...
                    <div className="card shadow">
                        <div className="card-header py-3">
                            <p className="text-primary m-0 fw-bold" style={{primary: '#00a0c4' , bsprimaryrgb: '0,160,196'}}><span style={{fontweight: 'normal !important', color: 'rgba(var(--bs-dark-rgb) var(--bs-text-opacity))'}}>Storage</span></p>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 col-xxl-4">
                                    <div className="text-end text-md-end dataTables_filter" id="dataTable_filter">
                                        <div></div><button className="btn btn-primary" type="button" style={{background: '#00a0c4' , padding: '6px 12px', primary: '#00a0c4' ,bsprimaryrgb: '0,160,196' ,bordercolor: '#00a0c4',paddingleft: '15px',marginleft: '-3px',height: '31px',paddingtop: '3px',width: '176.587px'}}>Upload file</button><label className="form-label"></label>
                                    </div>
                                </div>
